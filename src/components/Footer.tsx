        ...
        >
          ...
          <div style={{ maxWidth: '320px' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              ...
              {/* Location */}
              <a href="https://maps.google.com/?q=137,+Jawaharlal+Nehru+Salai,+opposite+to+sunshine+school,+AGS+Colony,+Velachery,+Chennai,+Tamil+Nadu+600042" target="_blank" rel="noopener noreferrer" aria-label="Location"
                style={{ width: '40px', height: '40px', borderRadius: '50%', background: '#FFFFFF', border: '1px solid #DADADA', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#8A8A8A', textDecoration: 'none', transition: 'all 0.3s ease' }}
                className="social-icon"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3px', textAlign: 'left' }}>
            <span style={{ fontSize: '0.6rem', fontWeight: 700, color: '#8A8A8A', textTransform: 'uppercase', letterSpacing: '0.15em', lineHeight: 1.2 }}>Crafted by</span>
