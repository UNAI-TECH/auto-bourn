...
function InventoryContent({ initialVehicles }: { initialVehicles: Vehicle[] }) {
  ...
  // Sync state if initialVehicles prop changes
  useEffect(() => {
...
export default function InventoryClient({ initialVehicles }: { initialVehicles: Vehicle[] }) {
  return (
    <Suspense fallback={
      ...
      <InventoryContent initialVehicles={initialVehicles} />
    </Suspense>
  );
}
